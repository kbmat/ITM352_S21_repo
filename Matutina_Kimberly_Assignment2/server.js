...
app.post('/process_login', function (request, response, next) {
    ...
    response.redirect('./login.html?' + queryString.stringify(request.query)); // If there are errors, redirect to same page
});
...
// Borrowed and modified code from Alyssa Mencel assignment 2 code https://github.com/amencel/ITM352_F20_repo/tree/master/mencel_alyssa_assignment2
